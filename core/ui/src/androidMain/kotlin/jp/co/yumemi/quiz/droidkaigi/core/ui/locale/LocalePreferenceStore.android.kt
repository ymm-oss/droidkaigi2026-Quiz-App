...
private class AndroidLocalePreferenceStore(context: Context) : LocalePreferenceStore {
    private val prefs = context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE)

    override fun load(): AppLocalePreference = AppLocalePreference.fromStorageKey(prefs.getString(KEY_LOCALE, null))
