...
Enter a nickname and start the quiz.

## Screenshot

<img src="/screenshots/android/android-home.png" alt="Home screen" width="280" />
...
| **Quiz type** | When more than one folder is published, pick using the public name and description configured by staff (e.g. General / Advanced). Hidden if only one is published |
